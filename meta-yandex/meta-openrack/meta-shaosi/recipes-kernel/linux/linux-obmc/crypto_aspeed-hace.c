...
static const struct of_device_id ast_hace_of_match_table[] = {
	{ .compatible = "aspeed,common", },
	{}
};
MODULE_DEVICE_TABLE(of, ast_hace_of_match_table);
...
static struct platform_driver aspeed_hace_driver = {
	...
	.driver		= {
		.name	= "aspeed_hace",
		.of_match_table = ast_hace_of_match_table,
	},
};
...
MODULE_DESCRIPTION("Support for Aspeed SoC hash & crypto engine");
MODULE_LICENSE("GPL");
